...
// Endpoint to update user's avatar , coverImage
const updateUserImage = asyncHandler(async (req, res, imageType) => {
  try {
    ...
    // Handle errors and respond with a generic internal error message
...
const updateUserCoverImage = (req, res) =>
  updateUserImage(req, res, "coverImage");

// Get the current user for parms
